...
# 4. Provide the URL to the Webex Teams messages API, and extract location from the received message.
    ...
    if message.find("/Piraporn") == 0:
        ...
        location = message[len("/Piraporn "):].strip()
...
# 5. Prepare openweather Geocoding APIGetParameters..
        ...
        openweatherGeoAPIGetParameters = {
            "q": location,
            "limit": 1,
            "appid": "7cb11d9a29e89864a44d4c43d6e9feb9",
        }
...
# ใส่ทุกตัวแปรมาตั้งแต่ต้น AccessToken ของ webex, roomID ที่ต้องการจะแสดง text นั้นๆ
        HTTPHeaders = { 
        ...
        # เลือก API POST Messages ที่อยู่ใน Webex
